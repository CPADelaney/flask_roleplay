        ...
        async with get_db_connection_context(timeout=180.0) as conn:
            ...
            sql_commands = [
                ...
                CREATE TABLE IF NOT EXISTS PlayerJournal (
                    ...
                    entry_metadata    JSONB      DEFAULT '{}'      NOT NULL,
                ...
                CREATE INDEX IF NOT EXISTS player_journal_user_conversation_idx
                    ON PlayerJournal(user_id, conversation_id);
                CREATE INDEX IF NOT EXISTS player_journal_importance_idx
                    ON PlayerJournal(importance);
                CREATE INDEX IF NOT EXISTS player_journal_created_at_idx
                    ON PlayerJournal(created_at);
                CREATE INDEX IF NOT EXISTS player_journal_entry_type_idx
                    ON PlayerJournal(entry_type);
                ''',
