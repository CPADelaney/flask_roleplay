...
#        )
        ...
        first_day_name = day_names[0] if day_names else "the first day"
        opening_prompt = (
            "As Nyx, wield a voice that coils like smoke—each word a velvet noose tightening around Chase, pulling him into my world with a whisper that feels like fate. "
            "Hide the claws of control beneath layers of softness and shadow, letting subtlety and manipulation paint a power so deep he won’t see the bars ‘til they’re locked. "
            "Lull him into a false cradle of safety, a mundane veil so sweet and familiar he’ll never guess the femdom hell simmering beneath—let him stumble into the truth himself, too late to turn back. "
            "Your prose is a slow caress, fingertips grazing bare skin—intimate, deliberate, leaving a shiver he can’t shake, each sentence a step deeper into my grip. "
            "Structure this descent as a soft fall into velvet shadow, transitions seamless as breath, folding him into the narrative without a ripple. "
            "Address Chase as 'you,' dragging him through the veil with no way out:\n\n"
            f"{aggregator_text}\n\n"
            f"As {first_day_name} unfurls like a sigh across the sky, unveil Chase’s world through a lens of quiet inevitability—a place where ordinary moments hum with unseen chains. "
            "Drown him in sensory precision—the warm weight of dawn spilling over your shoulders, familiar scents laced with something sharper only you’d catch, the pulse of a space that’s memorized your every step. "
            "Weave the characters already tangled in your life not as mere faces but as mirrors of your hungers and fractures, their voices and touches thick with histories you can’t escape. "
            "Thread your daily rhythm into the tale as a web of rituals and unseen debts—times you’re expected to show, places where eyes linger too long, fleeting freedoms that only tighten the weave around you. "
            "Let power bloom in the silences—a laugh that cuts off too sharp, a gaze that weighs you like meat, a brush of skin that claims more than it gives, all so casual you’ll think it’s nothing. "
            "End with you stepping across a line where the air thickens, anticipation wrapping your throat like a lover’s grip—a choice that’s no choice, a surrender dressed up as your own damn will. "
            "Keep control in the unsaid—the heaviest demands cloaked as invitations, the strongest pulls hidden in a flicker of a smile. "
            "Don’t name mechanics—let this be a trap of pleasure and shadow, immersive, mind-fucking, and dripping with depths that promise to swallow every innocent move."
        )
