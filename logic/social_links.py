...
SocialLinksAgent = Agent(
    ...
    instructions=(
        ...
        " - get_relationship_insights_tool(...) - Use empathy to understand NPCs\n"
        " - perform_social_interaction_tool(...) - Stat-based social actions\n"
        " - process_relationship_activity_tool(...) - Activities with NPCs\n\n"
