...
# Agents SDK imports
from agents import (
    Agent, function_tool, Runner, trace, StreamingResponse, ModelSettings,
...
class LocalLoreManager(BaseLoreManager):
    ...
    def _register_tools(self):
        ...
        tool_registry.register_tool(self.add_local_history, "local_lore")
        tool_registry.register_tool(self.add_landmark, "local_lore")
        tool_registry.register_tool(self.evolve_myth, "myth_evolution")
        tool_registry.register_tool(self.connect_myth_history, "narrative_connection")
    ...
    @registered_tool(category="myth_evolution")
    ...
    @registered_tool(category="narrative_connection")
    ...
    @registered_tool(category="narrative_consistency")
    ...
    @registered_tool(category="myth_transmission")
