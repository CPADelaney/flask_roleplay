...
def create_lore_tables():
    """
    Creates database tables for the lore system.
    """
    ...
    try:
        ...
        conn.commit()
        logging.info("Lore tables created successfully.")

    except Exception as e:
        conn.rollback()
        logging.error(f"Error creating lore tables: {e}")
        raise
    finally:
        cursor.close()
        conn.close()
