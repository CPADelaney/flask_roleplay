...
def start_new_game():
    ...
    # Create conversation_id here if not provided.
    ...
    # Offload heavy processing to the background task.
    # (Pass along the conversation_id so the background task uses it.)
    ...
    # Return both job_id and conversation_id so the client can track the conversation.
