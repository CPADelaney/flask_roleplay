    ...
    try:
        ...
        final_resp = {
            ...
            "npc_responses": [
                {
                    "npc_id": r.get("npc_id"),
                    "npc_name": await npc_system.get_npc_name(r.get("npc_id")),
                    "action": r.get("action",{}).get("description",""),
...
async def end_of_day():
    ...
    try:
        ...
        # Optionally confirm we are actually at 'Night' time before continuing, etc.
