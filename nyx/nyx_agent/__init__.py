...
# Models (harmonized with tools.py)
from .models import (
    # Base
    ...
    ScoreDecisionOptionsInput, DecideImageGenerationInput, DecideImageInput,  # alias kept for compat
    UpdateEmotionalStateInput, EmptyInput,

    # Output Models (aligned to tools)
    MemorySearchResult, MemoryStorageResult, UserGuidanceResult,
    ImageGenerationResult,  # general-purpose image op result (compat)
    EmotionalStateResult,   # returned by calculate_and_update_emotional_state
    RelationshipUpdate,
    PerformanceMetrics,     # returned by check_performance_metrics
    ActivityRecommendationsResult,
    DecisionScores, DecisionScoringResult,  # both exported for convenience/compat
    ConflictDetection, ConflictDetectionResult,
    PerformanceMetricsResult,  # compat wrapper some paths use
    UniversalUpdateResult,     # compat wrapper some paths use
)

# Context
from .context import NyxContext

# Tools (import guarded to avoid partial environment failures)
try:
    from .tools import (
        # Memory Tools
        retrieve_memories,
        ...
        calculate_emotional_impact,  # alias to calculate_and_update_emotional_state
        ...
        manage_beliefs,              # alias to score_decision_options (compat)
        score_decision_options,
        detect_conflicts_and_instability,

        # Image and Updates Tools
        decide_image_generation,
        generate_image_from_scene,   # alias to decide_image_generation (compat)
