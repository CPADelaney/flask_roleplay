...
class ProactiveCommunicationEngine:
    ...
    def __init__(self, 
        ...
        # Initialize agents
        self.intent_generation_agent = create_intent_generation_agent()
        self.content_generation_agent = create_content_generation_agent()
        self.timing_evaluation_agent = create_timing_evaluation_agent()
        
        # Add guardrails
        self.content_generation_agent.output_guardrails = [message_content_guardrail]
