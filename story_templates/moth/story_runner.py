...
_INTENT_MODEL = os.getenv("OPENAI_INTENT_MODEL", "gpt-4o-mini")
_CONTEXT_MODEL = os.getenv("OPENAI_CONTEXT_MODEL", "gpt-4o-mini") 
_NARRATIVE_MODEL = os.getenv("OPENAI_NARRATIVE_MODEL", "gpt-4o-mini")
_THREAT_MODEL = os.getenv("OPENAI_THREAT_MODEL", "gpt-4o-mini")
_INNER_VOICE_MODEL = os.getenv("OPENAI_INNER_VOICE_MODEL", "gpt-4o-mini")
_SCENE_MODEL = os.getenv("OPENAI_SCENE_MODEL", "gpt-4o-mini")
_DIALOGUE_MODEL = os.getenv("OPENAI_DIALOGUE_MODEL", "gpt-4o-mini")
_CONTINUITY_MODEL = os.getenv("OPENAI_CONTINUITY_MODEL", "gpt-4o-mini")
_MEMORY_MODEL = os.getenv("OPENAI_MEMORY_MODEL", "gpt-4o-mini")
_RIPPLE_MODEL = os.getenv("OPENAI_RIPPLE_MODEL", "gpt-4o-mini")
_SCHEDULER_MODEL = os.getenv("OPENAI_SCHEDULER_MODEL", "gpt-4o-mini")
_WEAVER_MODEL = os.getenv("OPENAI_WEAVER_MODEL", "gpt-4o-mini")
_PULSE_MODEL = os.getenv("OPENAI_PULSE_MODEL", "gpt-4o-mini")
_FOCUS_MODEL = os.getenv("OPENAI_FOCUS_MODEL", "gpt-4o-mini")
